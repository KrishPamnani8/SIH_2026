...
class Config:
    ...
    # Separate endpoint for ChangeTransformer/BIT bi-temporal analysis (can be same Colab server)
    # Falls back to COLAB_GPU_ENDPOINT with /change suffix if not set explicitly
    CHANGE_ANALYSIS_ENDPOINT: str = os.getenv("CHANGE_ANALYSIS_ENDPOINT", "")
